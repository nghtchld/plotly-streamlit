...
with col1:
    ...
    home_value = st.number_input("Enter your home value($): ", min_value=100000.0, format='%f')
    
    st.subheader("Loan Interest Rate")
    interest_rate = st.number_input("Enter your home loan interest rate(%): ", min_value=0.1, format='%f')

with col2:
    st.subheader("Down Payment Percent")
    down_payment_percent = st.number_input("Enter your down payment percent(%): ", min_value=1.0, format='%f')
